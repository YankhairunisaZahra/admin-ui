...
const AuthLayout = (props) => {
  ...
  return (
    <div className={`flex justify-center min-h-screen items-center ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      {/* container start */}
      {isLoading && (
        <SimpleBackdrop isLoading={isLoading} setIsLoading={setIsLoading} />
      )}
      <motion.div
        ...
        {/* teks start */}
        <div className="my-9 px-7 flex justify-center text-xs text-black items-center flex-col static">
          <div className="border border-gray-05 w-full"></div>
